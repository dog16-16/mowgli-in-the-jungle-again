...
function preload()
{
 ...
 boyImg = loadImage("pics/happy.jpg");
 boyImg1 = loadImage("pics/angry.jpg");
 boyImg2 = loadImage("pics/mowgli.jpg");
 monkeyImg  = loadImage("pics/monkey.jpg");
 monkey1Img = loadImage("pics/monkey1.jpg");
 console.log("testing")
}
...
//  score = 0;
  ...
  //str = new Chain(stone.body,{x:145, y:470});
	ground = new Ground(500,590,1000,20);
	stone = new Stone(200,150,70);
  chain = new Chain(stone.body,{x:145,y:470});
	//srting.Chain = new Chain(stone.body,{x:145, y:470});
